...
#### 🎨 新功能
- **B站电台**：新增 Bilibili 直播电台功能，支持搜索自习室、白噪音等分类，一键播放直播间声音
- **图钉收藏**：支持收藏常用直播间，快速切换，非直播房间自动置灰提示
- **自定义背景**：支持用户上传 PNG/GIF/MP4 作为应用背景，自动提取主题色跟随

#### ✨ 改进
- **编辑模式优化**：退出弹窗时自动关闭图钉编辑模式，避免误操作
- **预设弹窗改进**：编辑预设名称后关闭弹窗时自动重置编辑状态
