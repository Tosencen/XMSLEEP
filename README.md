...
- 🎵 **新增音频**：新增 21 个高质量音频
  - 雨声类别：新增 11 个雨声（雨落雨披、雨打窗台、雨敲木屋、开车时遇雨、空荡街道的雨、绵绵细雨、屋檐落雨、大雨落玻璃等）
  - 场所类别：新增厨房烹饪音频
  - 噪音类别：新增学习、吃薯片、钢琴声音频
- 🔄 **下拉刷新**：繁星页面主页新增下拉刷新功能，可手动刷新音频列表
- 🎨 **UI 优化**：未展开悬浮按钮的透明度从 38% 调整为 40%
- 🐛 **缓存修复**：添加版本检查机制，自动更新音频清单缓存，确保升级后能看到所有新音频
- 📊 **音频总数**：从 88 个增加到 109 个音频
